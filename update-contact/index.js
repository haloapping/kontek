...
const updateContactFormElement = document.getElementById("update-contact-form");

updateContactFormElement.addEventListener("submit", function (event) {
  ...
  const updatedContacts = localStorageContacts.map((contact) => {
