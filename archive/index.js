...
let localStorageContacts = loadContacts();
    ...
    const tableRowHTMLString = `
      <tr>
        ...
        <td>
          ...
          <button onclick="editContactByID(contacts, ${contact.ID})">Edit</button>
          <button onclick="deleteContactById(contacts, ${contact.ID})">Delete</button>
        </td>
      </tr>
        `;
...
function deleteContactById(contacts, ID) {
  ...
  if (isDeleted) {
    ...
    showAllContacts(updatedContacts);
