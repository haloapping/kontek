...
if (!contact) {
  ...
  document.getElementById(
    "fullName"
  ).textContent = `Full Name: ${contact.fullName}`;
  ...
  document.getElementById(
    "company"
  ).textContent = `Company: ${contact.company}`;
  document.getElementById(
    "jobTitle"
  ).textContent = `Job Title: ${contact.jobTitle}`;
  document.getElementById(
    "address"
  ).textContent = `Address: ${contact.address}`;
  document.getElementById(
    "birthdate"
  ).textContent = `Birthdate: ${contact.birthdate}`;
  document.getElementById("note").textContent = `Note: ${contact.note}`;
  document.getElementById("label").textContent = `Label: ${contact.label}`;
  document.getElementById("isFavorited").textContent = `Favorited: ${
    contact.isFavorited ? "Yes" : "No"
  }`;
  document.getElementById(
    "createdAt"
  ).textContent = `Created At: ${contact.createdAt}`;
  document.getElementById("updatedAt").textContent = `Updated At: ${
    contact.updatedAt || "-"
  }`;
  document.getElementById("deletedAt").textContent = `Deleted At: ${
    contact.deletedAt || "-"
  }`;
}
